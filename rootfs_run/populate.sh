...
pacman -Syyu base diffutils which iproute2 openssh zsh wget git vim rng-tools pwndbg gcc checksec ropper ropgadget radare2 --noconfirm;
echo "Creating udb0";
